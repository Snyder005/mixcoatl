...
def main(raft_id1, raft_id2, main_dir, calib_dir, output_dir='./'):
    ...
    sensor_id_list1 = ['{0}_{1}'.format(raft_id1, sensor_id) for sensor_id in sensor_list]
    sensor_id_list2 = ['{0}_{1}'.format(raft_id2, sensor_id) for sensor_id in sensor_list]
...
if __name__ == '__main__':
    ...
    parser.add_argument('raft_id1', type=str)
    parser.add_argument('raft_id2', type=str)
